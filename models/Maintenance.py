...
class Maintenance:
    def __init__(self, check_interval_months: int, initial_used_life_months: int, check_cost_min_dollars: float, check_cost_max_dollars: float) -> None:
    ...
    def get_random_check_cost(self) -> float:
