...
class ResidualValue(Statement):
    def get_amount(self) -> float:
        ...
        return round(residual_value, constants.DECIMALS)

    def __init__(self, date: date, residual_start: date, appraised_aircraft_value: float, depreciation_rate: float, is_end: bool = False):
